...
dash.override(Raw.prototype, {

    set: function set(sql, bindings) {
        this._cached = undefined;
        this.sql = sql;
        this.bindings = dash.isObject(bindings) && !bindings.toSQL || bindings === undefined ? bindings : [bindings];
    ...
    toSQL: function toSQL(method, tz) {
        ...
        if (Array.isArray(this.bindings)) {
            ...
            this._cached = {
                method: 'raw',
                sql: this.sql,
                bindings: this.bindings === undefined ? void 0 : [this.bindings]
            };
        }
        ...
        this._cached.options = (this._options || []).reduce(dash.override, {});
        if (this._timeout) {
