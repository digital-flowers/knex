...
dash.override(Runner.prototype, {
    ...
    query: _promise2['default'].method(function (obj) {
        ...
        this.builder.emit('query', dash.override({__knexUid: this.connection.__knexUid}, obj));
        var runner = this;
        ...
        return queryPromise.then(function (resp) {
            ...
            _this.builder.emit('query-response', processedResponse, dash.override({__knexUid: _this.connection.__knexUid}, obj), _this.builder);
            _this.client.emit('query-response', processedResponse, dash.override({__knexUid: _this.connection.__knexUid}, obj), _this.builder);
            ...
            return cancelQuery['catch'](function (cancelError) {
                // cancellation failed
                throw dash.override(cancelError, {
                    message: 'After query timeout of ' + timeout + 'ms exceeded, cancelling of query failed.',
                    sql: sql, bindings: bindings, timeout: timeout
                });
            }).then(function () {
                // cancellation succeeded, rethrow timeout error
                throw dash.override(error, {
                    message: 'Defined query timeout of ' + timeout + 'ms exceeded when running query.',
                    sql: sql, bindings: bindings, timeout: timeout
                });
            });
        })['catch'](function (error) {
            _this.builder.emit('query-error', error, dash.override({__knexUid: _this.connection.__knexUid}, obj));
            throw error;
        });
    }),
        ...
        return _promise2['default']['try'](function () {
            return runner.connection || new _promise2['default'](function (resolver, rejecter) {
                    ...
                    acquireConnection.completed.timeout(acquireConnectionTimeout).then(resolver)['catch'](_promise2['default'].TimeoutError, function (error) {
                        ...
                        dash.override(timeoutError, additionalErrorInformation);
