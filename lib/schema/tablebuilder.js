...
TableBuilder.prototype.toSQL = function () {
    if (this._method === 'alter') {
        dash.override(this, AlterMethods);
    }
...
['index', 'primary', 'unique', 'dropPrimary', 'dropUnique', 'dropIndex', 'dropForeign'].forEach(function (method) {
    TableBuilder.prototype[method] = function () {
        this._statements.push({
            grouping: 'alterTable',
            method: method,
            args: dash.toArray(arguments)
        });
        return this;
    };
});
...
Object.keys(specialMethods).forEach(function (dialect) {
    var methods = specialMethods[dialect];
...
columnTypes.forEach(function (type) {
    TableBuilder.prototype[type] = function () {
        var args = dash.toArray(arguments);
...
TableBuilder.prototype.foreign = function (column) {
    ...
    var returnObj = {
        ...
        _columnBuilder: function _columnBuilder(builder) {
            dash.override(builder, returnObj);
            returnObj = builder;
            return builder;
        }
    };
