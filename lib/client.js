...
dash.override(Client.prototype, {
    ...
    query: function query(connection, obj) {
        ...
        this.emit('query', dash.override({__knexUid: connection.__knexUid}, obj));
        debugQuery(obj.sql);
        return this._query.call(this, connection, obj)['catch'](function (err) {
            ...
            _this.emit('query-error', err, dash.override({__knexUid: connection.__knexUid}, obj));
            throw err;
        });
    },
    ...
    initializePool: function initializePool(config) {
        ...
        this.pool = new this.Pool(dash.override(this.poolDefaults(config.pool || {}), config.pool || {}));
        ...
        return {
            ...
            acquire: function acquire(callback) {
                client.acquireRawConnection().tap(function (connection) {
                    connection.__knexUid = dash.uniqueId('__knexUid');
